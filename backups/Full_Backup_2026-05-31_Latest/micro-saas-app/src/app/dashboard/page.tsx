    ...
    >
      ...
      <main className="flex-1 pb-24 overflow-y-auto">
        <div className="max-w-full px-2 sm:px-4 py-8">
          ...
          {!isSubscribed && (
            <div className=      <nav className={`fixed bottom-0 left-0 right-0 h-14 border-t backdrop-blur-2xl z-50 flex items-center justify-around px-4 ${isDarkMode ? 'bg-zinc-950/90 border-zinc-800' : 'bg-white/90 border-zinc-100 shadow-[0_-10px_40px_rgba(0,0,0,0.04)]'}`}>
          ...
          <div className="text-center space-y-8 animate-in zoom-in-95 duration-500">
            ...
            <div className="space-y-2">
              ...
              <DialogDescription className="text-zinc-500 font-bold italic text-center">
                {t("Order has been completed and saved to cloud.")}dleLogout();
                try {
                  const { App } = await import('@capacitor/app');
                  await App.exitApp();
                } catch (e) {
