...
export default function LandingPage() {
  ...
  return (
    <div className="bg-black text-white font-sans selection:bg-orange-500 selection:text-white scroll-smooth overflow-x-hidden min-h-screen">
      {/* Navigation */}
      <nav className={`fixed top-0 w-full z-[100] transition-all duration-300 ${scrolled ? "bg-zinc-950 border-b border-white/10 py-3 shadow-2xl" : "bg-transparent py-6"}`}>
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-4">
             <img src="/assets/logo-light.png" alt="InstaMunim" className="w-12 h-12 md:w-20 md:h-20 object-contain" />
             <div className="flex flex-col">
                <span className="text-xl md:text-4xl font-black tracking-tighter italic leading-none">INSTAMUNIM</span>
                <span className="text-[10px] md:text-[14px] font-black tracking-[0.4em] text-orange-500 italic uppercase ml-1">Beyond Billing</span>
             </div>
          </div>
          
          <div className="hidden lg:flex items-center gap-10 text-[12px] font-black tracking-widest text-zinc-400">
          ...
          <div className="flex items-center gap-4">
            <a 
              ...
              className="bg-orange-500 hover:bg-orange-600 px-6 md:px-10 py-3 md:py-4 rounded-full font-black text-[12px] md:text-[16px] transition-all hover:scale-105 active:scale-95 flex items-center gap-2 shadow-xl shadow-orange-500/20"
            >
              <Download size={20} /> <span className="hidden sm:inline">DOWNLOAD</span> APK
            </a>
          </div>
        </div>
      </nav>
      ...
      {/* Hero Section */}
      <section className="relative pt-48 md:pt-64 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center">
          <h1 className="text-5xl md:text-[140px] font-black tracking-tighter leading-[0.8] mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-32">
            ...
            >
              FREE TRIAL <ArrowRight className="group-hover:translate-x-2 transition-transform" />
            </a>
            <a 
          ...
          <div className="max-w-7xl mx-auto py-12 px-6 bg-gradient-to-r from-orange-600/20 to-orange-400/20 rounded-[40px] border border-orange-500/30 backdrop-blur-md overflow-hidden relative shadow-[0_0_50px_rgba(249,115,22,0.1)]">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 relative z-10">
              <div className="flex flex-col items-center gap-1 transition-transform hover:scale-105 duration-500">
                <span className="text-4xl md:text-6xl font-black italic text-orange-500 drop-shadow-[0_0_15px_rgba(249,115,22,0.4)]">100+</span>
                <span className="text-[9px] md:text-[11px] font-black tracking-[0.3em] text-white/80 uppercase">Merchants</span>
              </div>
              <div className="flex flex-col items-center gap-1 transition-transform hover:scale-105 duration-500">
                <span className="text-4xl md:text-6xl font-black italic text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]">50K+</span>
                <span className="text-[9px] md:text-[11px] font-black tracking-[0.3em] text-white/80 uppercase">Invoices</span>
              </div>
              <div className="flex flex-col items-center gap-1 transition-transform hover:scale-105 duration-500">
                <span className="text-4xl md:text-6xl font-black italic text-orange-500 drop-shadow-[0_0_15px_rgba(249,115,22,0.4)]">4.9/5</span>
                <span className="text-[9px] md:text-[11px] font-black tracking-[0.3em] text-white/80 uppercase">Rating</span>
              </div>
              <div className="flex flex-col items-center gap-1 transition-transform hover:scale-105 duration-500">
                <span className="text-4xl md:text-6xl font-black italic text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]">100%</span>
      ...
      <section id="features" className="py-32 bg-zinc-950 relative">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center mb-24 gap-10">
            ...
            <div className="bg-orange-500 px-10 py-5 rounded-3xl font-black text-black text-xl shadow-2xl shadow-orange-500/20">MAKE IN INDIA 🇮🇳</div>
          </div>
      ...
      <section id="plans" className="py-32 relative overflow-hidden bg-black">
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-xl mx-auto bg-gradient-to-b from-zinc-900/80 to-black border-2 border-orange-500/50 p-10 md:p-16 rounded-[60px] relative shadow-[0_0_100px_rgba(249,115,22,0.1)]">
            <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-orange-500 text-black px-10 py-3 rounded-full font-black text-[10px] uppercase tracking-[0.3em] shadow-2xl">SMART BUSINESS</div>
            ...
            <div className="flex justify-center">
              <a 
                href="https://wa.me/917838229178" 
                className="w-auto bg-orange-500 hover:bg-orange-600 text-white px-8 md:px-12 py-5 md:py-7 rounded-3xl font-black text-lg md:text-2xl transition-all flex items-center justify-center gap-4 shadow-2xl shadow-orange-500/30"
              >
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-16 mb-20">
            <div className="max-w-sm">
              <div className="flex items-center gap-4 mb-6">
                <img src="/assets/logo-light.png" alt="InstaMunim" className="w-12 h-12" />
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-12 md:gap-24">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex gap-4">
                  {/* SVG Icons */}
                  <a href="#" className="text-zinc-500 hover:text-orange-500 transition-colors"><svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg></a>
                  <a href="#" className="text-zinc-500 hover:text-orange-500 transition-colors"><svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg></a>
                  <a href="#" className="text-zinc-500 hover:text-orange-500 transition-colors"><svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg></a>
                </div>
              </div>
              <div className="flex flex-col gap-6">
